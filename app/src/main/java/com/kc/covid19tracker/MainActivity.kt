...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        list.addHeaderView(LayoutInflater.from(this)
            .inflate(R.layout.item_header,list,false))

        fetchResults()
    }

    private fun fetchResults() {
        // here sometimes app might crash due to some problem in networking this is why we use coroutine
        GlobalScope.launch {
